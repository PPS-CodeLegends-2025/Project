<script lang="ts">
    ...
    let filteredModules = $derived(modules.filter(module => {
...
<div class="container mx-auto p-6">
    <h1 class="text-3xl font-bold mb-8">Learning Modules</h1>
    ...
    {#if filteredModules.length > 0}
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {#each filteredModules as module}
                <button type="button" 
                        class="box hover:shadow-lg transition-shadow cursor-pointer w-full text-left"
                        onclick={() => goToModule(module.id)}>
                    <div class="h-40 bg-slate-100 rounded-t-lg flex items-center justify-center">
                    ...
                    <div class="p-4">
                        ...
                        {#if module.progress > 0}
                            <div class="mt-4">
                                ...
                                <div class="text-xs text-right mt-1">{module.progress}% complete</div>
                            </div>
                        {:else}
