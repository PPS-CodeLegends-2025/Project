    ...
    const modules = [
        {
            ...
            sections: [
                { 
                    ...
                    isCompleted: false,
                    content: 'JavaScript is a programming language that enables interactive web pages. This section covers the basics of what JavaScript is and its role in web development.'
                },
                { 
                    id: 'variables', 
                    title: 'Variables and Data Types', 
                    isCompleted: false,
                    content: 'Learn how to declare variables and understand the different data types in JavaScript, including strings, numbers, booleans, and objects.'
                },
                { 
                    id: 'functions', 
                    title: 'Working with Functions', 
                    isCompleted: false,
                    content: 'Functions are reusable blocks of code. This section explains how to define and call functions, pass parameters, and return values.'
                }
            ]
        },
        {
            ...
            sections: [
                ...
                { 
                    ...
                    isCompleted: false,
                    content: 'Learn how to work with asynchronous code using Promises and the async/await syntax.'
                },
                { 
                    id: 'modules', 
                    title: 'JavaScript Modules', 
                    isCompleted: false,
                    content: 'Explore how to organize your code using JavaScript modules with import and export statements.'
                }
            ]
        },
        {
            ...
            sections: [
                ...
                { 
                    ...
                    isCompleted: false,
                    content: 'Learn how to define complex types using interfaces and type aliases in TypeScript.'
                }
            ]
        },
        {
            ...
            sections: [
                ...
                { 
                    ...
                    isCompleted: false,
                    content: 'Understand Svelte\'s unique approach to reactivity and how to leverage it in your applications.'
                }
            ]
        }
    ];
...
<div class="container mx-auto p-6">
    <div class="mb-6 flex items-center justify-between">
        <button class="btn btn-ghost" on:click={goToModule}>
    ...
    {#if module && currentSection}
        <div class="box bg-white p-6 rounded-lg shadow">
            <h1 class="text-2xl font-bold mb-2">{currentSection.title}</h1>
            
            <div class="flex justify-between items-center mb-6">
                <div class="badge bg-blue-100 text-blue-800">Section {currentSectionIndex + 1} of {sections.length}</div>
...
function example() \{
    console.log("This is an example")};
            ...
            <div class="flex justify-between mt-10">
                <div>
                    {#if prevSection}
                        <button class="btn btn-outline" on:click={() => goToSection(prevSection.id)}>
                ...
                <div class="flex gap-2">
                    {#if !currentSection.isCompleted}
                        <button class="btn btn-primary" on:click={markAsCompleted}>
                            Mark as Completed
                        </button>
                    {/if}
                    
                    {#if nextSection}
                        <button class="btn btn-primary" on:click={() => goToSection(nextSection.id)}>
                    ...
                    {:else}
                        <button class="btn btn-success" on:click={goToModule}>
                            Complete Module
                        </button>
                    {/if}
                </div>
    ...
    {:else}
        <div class="box py-12 text-center">
            ...
            <button class="btn btn-primary mt-4" on:click={goToModule}>Return to Module</button>
        </div>
    {/if}
</div>
