...
--> statement-breakpoint
ALTER TABLE `user_course_progress` DROP FOREIGN KEY `user_course_progress_course_id_course_id_fk`;
--> statement-breakpoint
ALTER TABLE `module_progress` ADD CONSTRAINT `module_progress_user_id_user_id_fk` FOREIGN KEY (`user_id`) REFERENCES `user`(`id`) ON DELETE no action ON UPDATE no action;--> statement-breakpoint
